...
export function FavoritesToggle({ userId }: { userId: number }) {
  ...
  return (
    <button
      ...
      className="p-1 rounded-md text-neutral-700 dark:text-neutral-400 border border-neutral-300 dark:border-neutral-700 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all hover:scale-105 cursor-pointer z-10"
    >
      {fav ? (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="size-5 text-neutral-500 dark:text-neutral-400">
